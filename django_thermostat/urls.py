...
urlpatterns = patterns('',
    ...
    url(r'^put_heat_manual', "django_thermostat.views.put_heat_manual", name="put_heat_manual"),
    url(r'^put_heat_program', "django_thermostat.views.put_heat_program", name="put_heat_program"),
